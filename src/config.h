...
#define M2_DAQ_MAX_CHAN 32
#define M2_DAQ_VIRTUAL_NUM_DAC 8   // =< M2_DAQ_MAX_CHAN
#define M2_DAQ_VIRTUAL_NUM_ADC 16  // =< M2_DAQ_MAX_CHAN
#define M2_DAQ_VIRTUAL_NUM_DIO 32  // =< M2_DAQ_MAX_CHAN
